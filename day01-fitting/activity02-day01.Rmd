...
The slope is linear, which means both the values have a high correlation coefficient, therefore the linear equation for the model will be: hf_score = 5.0534 + 0.3684 * pf_expression_control. 
